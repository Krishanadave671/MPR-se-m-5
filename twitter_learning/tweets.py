...
class TwitterClient():
    def __init__(self, twitter_user=None): # default will be None parameter 
...
if __name__ == '__main__':
    ...
    tweets = api.user_timeline(screen_name="MTPHereToHelp", count=10000)

    #print(dir(tweets[0]))
    #print(tweets[0].retweet_count)

    df = tweet_analyzer.tweets_to_data_frame(tweets)
    df.to_csv("MTPHereToHelp5.csv", index = False)
    
    # hash_tag_list = ["MumbaiTrafficUpdates"]
    # fetched_tweets_filename = "tweets.txt"
    

    # twitter_client = TwitterClient('MTPHereToHelp')
    # print(twitter_client.get_user_timeline_tweets)